...
import net.galaxycore.borderrun.utils.ColoredConsole.Companion.BLACK
import net.galaxycore.borderrun.utils.ColoredConsole.Companion.BRIGHT_BLACK
import net.galaxycore.borderrun.utils.ColoredConsole.Companion.BRIGHT_WHITE
import net.galaxycore.borderrun.utils.ColoredConsole.Companion.RESET
import net.galaxycore.borderrun.utils.ColoredConsole.Companion.WHITE
import net.galaxycore.borderrun.utils.ColoredConsole.Style
import net.galaxycore.borderrun.utils.ColoredConsole.Style.NotApplied
...
interface ColoredConsole {
    ...
    companion object {
        ...
        val pattern: Pattern = Pattern.compile("\\u001B\\[(\\d{1,2})m")
    }
}
