...
package net.galaxycore.borderrun.runnables
...
fun task(
    ...
    val bukkitRunnable = object : KSpigotRunnable(endCallback = endCallback, cancelCallback = cancelCallback) {
